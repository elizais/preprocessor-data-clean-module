...
export class PreprocessorService {
  ...
  public getRawData(_params: AddressDto): Promise<GetDataDto> {
  ...
  //
  //   if (!user) {
  //     PreprocessorService.__throwUserNotFoundException(params);
  //   }
  //
  //   return user;
  // }
  ...
  //
  //   if (!isUserExists) {
  //     PreprocessorService.__throwUserNotFoundException(options);
  //   }
  // }
}
